 ...
 */
@Stateless
public class GrupoComponenteRxDaoImpl extends BaseJPADao<VGrupoComponente> implements GrupoComponenteRxDao, Serializable  {
	 ...
	 */ 
	@Override
	public List<VGrupoComponente> consultarGrupoComponente(GrupoComponenteFiltroDto request) throws DaoException {
		
		StringBuilder jpql = null;
		StringBuilder jpqlSelect = null;
		StringBuilder jpqlWhere = null;
		metodo = Thread.currentThread().getStackTrace()[1].getMethodName();
		TypedQuery<VGrupoComponente> query = null;
		List<VGrupoComponente> resultado = null;
		try {
			...
			query = entityManager.createQuery(jpql.toString(), VGrupoComponente.class);
			if(request.getIdGrupo() != null) {
